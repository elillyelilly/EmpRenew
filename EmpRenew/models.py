...
class EmprenewEmpcolumn(models.Model):
    ...
    shain_cd = models.CharField(max_length=10)
    shain_nm = models.CharField(max_length=100, blank=True, null=True)
    created_date = models.DateTimeField(db_column='crt_date', default=timezone.now)

#     shain_nm_k = models.CharField(max_length=100, blank=True, null=True)
...
#     shugyou1_break = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou2_break = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou3_break = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou4_break = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shurou_nissu = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
...
#     shugyou1_kosu = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou2_kosu = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou3_kosu = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     shugyou4_kosu = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True)
#     next_uq_day_num = models.DecimalField(max_digits=10, decimal_places=4, blank=True, null=True)
...
class Empcolumn(models.Model):
    id = models.IntegerField(db_column='id', primary_key=True)
    shain_cd = models.CharField(db_column='shain_cd',max_length=10)
    shain_nm = models.CharField(db_column='shain_nm', max_length=100, blank=True, null=True)
    shain_nm_k = models.CharField(db_column='shain_nm_k', max_length=100, blank=True, null=True)
    adr1 = models.CharField(db_column='adr1', max_length=100)
    adr2 = models.CharField(db_column='adr2', max_length=100)
    tel1 = models.CharField(db_column='tel1', max_length=13)
    birth_date = models.DateTimeField(db_column='birth_date', blank=True, null=True)
    keiyaku_start_date =  models.DateTimeField(db_column='keiyaku_start_date')
    keiyaku_end_date = models.DateTimeField(db_column='keiyaku_end_date')
    genba_name = models.CharField(db_column='genba_name', max_length=100)
    shugyou1_to = models.IntegerField(db_column='shugyou1_to', blank=True, null=True) 
    shugyou2_to = models.IntegerField(db_column='shugyou2_to', blank=True, null=True) 
    shugyou3_to = models.IntegerField(db_column='shugyou3_to', blank=True, null=True) 
    shugyou4_to = models.IntegerField(db_column='shugyou4_to', blank=True, null=True) 
    shugyou1_from = models.IntegerField(db_column='shugyou1_from', blank=True, null=True) 
    shugyou2_from = models.IntegerField(db_column='shugyou2_from', blank=True, null=True) 
    shugyou3_from = models.IntegerField(db_column='shugyou3_from', blank=True, null=True) 
    shugyou4_from = models.IntegerField(db_column='shugyou4_from', blank=True, null=True) 
    shugyou1_break = models.DecimalField(db_column='shugyou1_break', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou2_break = models.DecimalField(db_column='shugyou2_break', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou3_break = models.DecimalField(db_column='shugyou3_break', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou4_break = models.DecimalField(db_column='shugyou4_break', max_digits=19, decimal_places=4, blank=True, null=True)
    shurou_nissu = models.DecimalField(db_column='shurou_nissu', max_digits=10, decimal_places=4, blank=True, null=True)
    shoku_name = models.CharField(db_column='shoku_name', max_length=100)
    chingin_kbn = models.CharField(db_column='chingin_kbn', max_length=3)
    chingin_dt_1 = models.IntegerField(db_column='chingin_dt_1', blank=True, null=True) 
    chingin_dt_2 = models.IntegerField(db_column='chingin_dt_2', blank=True, null=True) 
    chingin_dt_3 = models.IntegerField(db_column='chingin_dt_3', blank=True, null=True) 
    next_uq_date = models.DateTimeField(db_column='next_uq_date', blank=True, null=True)
    shugyou1_kosu = models.DecimalField(db_column='shugyou1_kosu', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou2_kosu = models.DecimalField(db_column='shugyou2_kosu', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou3_kosu = models.DecimalField(db_column='shugyou3_kosu', max_digits=19, decimal_places=4, blank=True, null=True)
    shugyou4_kosu = models.DecimalField(db_column='shugyou4_kosu', max_digits=19, decimal_places=4, blank=True, null=True)
    next_uq_day_num = models.DecimalField(db_column='next_uq_day_num', max_digits=10, decimal_places=4, blank=True, null=True)
    tou_str_uq_zan_num = models.CharField(db_column='tou_str_uq_zan_num', max_length=50)
    koyou_hoken_kbn = models.CharField(db_column='koyou_hoken_kbn', max_length=1)
    shakai_hoken_kbn_cd = models.CharField(db_column='shakai_hoken_kbn_cd', max_length=1)
    created_date = models.DateTimeField(db_column='crt_date', default=timezone.now)
